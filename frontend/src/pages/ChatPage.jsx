...
// Component ab 'theme' aur 'toggleTheme' ko props se lega
function ChatPage({ theme, toggleTheme }) {
  ...
  // Local theme state yahan se hata diya gaya hai
  ...
  const handleUpload = async () => {
    // Note: We'll add auth headers here tomorrow
    if (!file) return;
  ...
  return (
    // The main div no longer needs the theme class, as it's on the root html element
    <div className="h-screen flex flex-col font-sans bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-white transition-colors duration-300">
      <header className="p-4 bg-white dark:bg-gray-800/50 backdrop-blur-sm border-b border-gray-200 dark:border-gray-700 flex justify-between items-center shadow-md">
        ...
        <div className="flex items-center gap-4">
          ...
          {/* Button ab props se mile function ko call karega */}
